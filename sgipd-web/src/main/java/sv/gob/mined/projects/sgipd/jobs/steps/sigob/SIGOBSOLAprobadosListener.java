...
@Named
@Dependent
public class SIGOBSOLAprobadosListener extends AbstractItemWriteListener {
    private static Logger LOG = Logger.getLogger(SIGOBSOLAprobadosListener.class);
    @Inject
    private JobContext jobContext;

    @Override
    public void afterWrite(List<Object> items) throws Exception {
        LOG.info("Persisting " + items.size() + " SIGOBSOLAprobados");
    }

    @Override
    public void beforeWrite(List<Object> items) throws Exception {
        LOG.info("Preparing to persist " + items.size() + " SIGOBSOLAprobados");
    }
