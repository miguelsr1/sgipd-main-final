...
@Named
@Dependent
public class Criterio5Processor implements ItemProcessor {
    private static Logger LOG = Logger.getLogger(Criterio5Processor.class);
    @Inject
    ...
    public List<Calificacion> processItem(Object o) throws Exception {
        ...
        return calificacionRepository.fromDocente_2_CalificacionListCriterio5(d,currentUser);
    }
}
