...
@Named
@Dependent
public class Criterio4aProcessor implements ItemProcessor {
    private static Logger LOG = Logger.getLogger(Criterio4aProcessor.class);
    @Inject
    ...
    public List<Calificacion> processItem(Object o) throws Exception {
        ...
        return calificacionRepository.fromDocente_2_CalificacionListCriterio4a(d,currentUser);
    }
}
