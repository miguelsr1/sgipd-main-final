...
@Named
@Dependent
public class EncontrarProcessor implements ItemProcessor {
    private static Logger LOG = Logger.getLogger(EncontrarProcessor.class);
    @Inject
    ...
    public List<DocentesRevint> processItem(Object o) throws Exception {
        ...
        return docenteRevintRepository.fromDocente_2_DocenteRevint(d,currentUser);
    }
}
