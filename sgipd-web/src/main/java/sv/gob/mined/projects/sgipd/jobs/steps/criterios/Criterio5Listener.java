...
@Named
@Dependent
public class Criterio5Listener extends AbstractItemWriteListener {
    private static Logger LOG = Logger.getLogger(Criterio5Listener.class);
    @Inject
    private JobContext jobContext;

    @Override
    public void afterWrite(List<Object> items) throws Exception {
        LOG.info("Persisting " + items.size() + " Criterio5");
    }

    @Override
    public void beforeWrite(List<Object> items) throws Exception {
        LOG.info("Preparing to persist " + items.size() + " Criterio5");
    }
