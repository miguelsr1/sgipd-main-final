...
@Named
@Dependent
public class ClasificadorPlazaListener extends AbstractItemWriteListener {
    private static Logger LOG = Logger.getLogger(ClasificadorPlazaListener.class);
    @Inject
    private JobContext jobContext;

    @Override
    public void afterWrite(List<Object> items) throws Exception {
        LOG.info("Persisting " + items.size() + " ClasificadorPlaza");
    }

    @Override
    public void beforeWrite(List<Object> items) throws Exception {
        LOG.info("Preparing to persist " + items.size() + " ClasificadorPlaza");
    }
