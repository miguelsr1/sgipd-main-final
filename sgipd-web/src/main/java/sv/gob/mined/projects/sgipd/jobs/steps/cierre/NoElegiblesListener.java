...
@Named
@Dependent
public class NoElegiblesListener extends AbstractItemWriteListener {
    private static Logger LOG = Logger.getLogger(NoElegiblesListener.class);
    @Inject
    private JobContext jobContext;

    @Override
    public void afterWrite(List<Object> items) throws Exception {
        LOG.info("Persisting " + items.size() + " NoElegibles");
    }

    @Override
    public void beforeWrite(List<Object> items) throws Exception {
        LOG.info("Preparing to persist " + items.size() + " NoElegibles");
    }
