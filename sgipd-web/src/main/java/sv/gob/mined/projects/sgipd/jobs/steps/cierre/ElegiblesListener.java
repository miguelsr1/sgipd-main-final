...
@Named
@Dependent
public class ElegiblesListener extends AbstractItemWriteListener {
    private static Logger LOG = Logger.getLogger(ElegiblesListener.class);
    @Inject
    private JobContext jobContext;

    @Override
    public void afterWrite(List<Object> items) throws Exception {
        LOG.info("Persisting " + items.size() + " Elegibles");
    }

    @Override
    public void beforeWrite(List<Object> items) throws Exception {
        LOG.info("Preparing to persist " + items.size() + " Elegibles");
    }
