...
import sv.gob.mined.projects.sgipd.services.Criterio2V2Service;
...
@Named
@ViewScoped
public class Criterio2V2FullBean extends XBaseBean implements Serializable {
    ...
    private List<ReporteCriterio2V2> listadoCalificaciones;
    ...
    @Inject
    private Criterio2V2Service criterio2Service;
    @Inject
    ...
    public List<ReporteCriterio2V2> getListadoCalificaciones() {
        return listadoCalificaciones;
    }

    public void setListadoCalificaciones(List<ReporteCriterio2V2> listadoCalificaciones) {
