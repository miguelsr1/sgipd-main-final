...
@Named
@Dependent
public class VexpedienteDocentesE2CvListener extends AbstractItemWriteListener {
    private static Logger LOG = Logger.getLogger(VexpedienteDocentesE2CvListener.class);
    @Inject
    private JobContext jobContext;

    @Override
    public void afterWrite(List<Object> items) throws Exception {
        LOG.info("Persisting " + items.size() + " NuevosDatosExpediente");
    }

    @Override
    public void beforeWrite(List<Object> items) throws Exception {
        LOG.info("Preparing to persist " + items.size() + " NuevosDatosExpediente");
    }
