...
@Named
@Dependent
public class EncontrarCapacitacionesListener extends AbstractItemWriteListener {
    private static Logger LOG = Logger.getLogger(EncontrarCapacitacionesListener.class);
    @Inject
    private JobContext jobContext;

    @Override
    public void afterWrite(List<Object> items) throws Exception {
        LOG.info("Persisting " + items.size() + " EncontrarCapacitaciones");
    }

    @Override
    public void beforeWrite(List<Object> items) throws Exception {
        LOG.info("Preparing to persist " + items.size() + " EncontrarCapacitaciones");
    }
