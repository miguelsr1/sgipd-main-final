...
@Named
@Dependent
public class NonTop10PlazaListener extends AbstractItemWriteListener {
    private static Logger LOG = Logger.getLogger(NonTop10PlazaListener.class);
    @Inject
    private JobContext jobContext;

    @Override
    public void afterWrite(List<Object> items) throws Exception {
        LOG.info("Persisting " + items.size() + " NonTop10Plaza");
    }

    @Override
    public void beforeWrite(List<Object> items) throws Exception {
        LOG.info("Preparing to persist " + items.size() + " NonTop10Plaza");
    }
