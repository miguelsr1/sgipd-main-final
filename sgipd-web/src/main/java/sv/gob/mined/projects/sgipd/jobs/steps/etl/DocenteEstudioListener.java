...
@Named
@Dependent
public class DocenteEstudioListener extends AbstractItemWriteListener {
    private static Logger LOG = Logger.getLogger(DocenteEstudioListener.class);
    @Inject
    private JobContext jobContext;

    @Override
    public void afterWrite(List<Object> items) throws Exception {
        LOG.info("Persisting " + items.size() + " DocenteEstudio");
    }

    @Override
    public void beforeWrite(List<Object> items) throws Exception {
        LOG.info("Preparing to persist " + items.size() + " DocenteEstudio");
    }
