...
@Named
@Dependent
public class Criterio4aListener extends AbstractItemWriteListener {
    private static Logger LOG = Logger.getLogger(Criterio4aListener.class);
    @Inject
    private JobContext jobContext;

    @Override
    public void afterWrite(List<Object> items) throws Exception {
        LOG.info("Persisting " + items.size() + " Crtiterio4a");
    }

    @Override
    public void beforeWrite(List<Object> items) throws Exception {
        LOG.info("Preparing to persist " + items.size() + " Crtiterio4a");
    }
