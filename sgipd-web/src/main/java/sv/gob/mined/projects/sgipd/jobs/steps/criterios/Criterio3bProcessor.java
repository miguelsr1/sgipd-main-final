...
@Named
@Dependent
public class Criterio3bProcessor implements ItemProcessor {
    private static Logger LOG = Logger.getLogger(Criterio3bProcessor.class);
    @Inject
    ...
    public List<Calificacion> processItem(Object o) throws Exception {
        ...
        return calificacionRepository.fromDocente_2_CalificacionListCriterio3b(d,currentUser);
    }
}
