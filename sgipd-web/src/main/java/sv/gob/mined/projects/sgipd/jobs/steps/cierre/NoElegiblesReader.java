...
@Named
@Dependent
public class NoElegiblesReader extends AbstractItemReader {
    private static Logger LOG = Logger.getLogger(NoElegiblesReader.class);
    @Inject
    ...
    public void open(Serializable checkpoint) throws Exception {
        data = docenteRepository.findNoElegibles();
