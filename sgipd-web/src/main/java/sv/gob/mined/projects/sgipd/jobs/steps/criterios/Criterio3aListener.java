...
@Named
@Dependent
public class Criterio3aListener extends AbstractItemWriteListener {
    private static Logger LOG = Logger.getLogger(Criterio3aListener.class);
    @Inject
    private JobContext jobContext;

    @Override
    public void afterWrite(List<Object> items) throws Exception {
        LOG.info("Persisting " + items.size() + " Criterio3a");
    }

    @Override
    public void beforeWrite(List<Object> items) throws Exception {
        LOG.info("Preparing to persist " + items.size() + " Criterio3a");
    }
