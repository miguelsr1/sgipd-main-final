...
public class Criterio2Service {
    ...
    @Inject
    private ReporteCriterio2Service reporteCriterio2Service;
    ...
    public Map<String,Long> saveExcelFileCriterio2PruebaConocimientos(
        ...
        return calificacionRepository.saveExcelFileCriterio2PruebaConocimientos(listadoCalificaciones,usuario);
    }
    ...
    public List<ReporteCriterio2> findByCriteriaReporteCriterio2(
        ...
        return reporteCriterio2Service.findByCriteriaReporteCriterio2(criteria,id);
    }
    ...
    public byte[] crearPlantillaPruebaConocimientos(List<ReporteCriterio2> lines) {
        return excelUtil.crearPlantillaPruebaConocimientos(lines);
    }
    ...
    public byte[] crearPlantillaPruebaConocimientos(Criterio2ServiceEnum seleccionado,long id){
        return crearPlantillaPruebaConocimientos(this.findByCriteriaReporteCriterio2(seleccionado, id));
    }
    ...
    public List<ReporteCriterio2> readXLSXCalificacionFile(File file) {
        return excelUtil.readXLSXCalificacionFile(file);
    }
